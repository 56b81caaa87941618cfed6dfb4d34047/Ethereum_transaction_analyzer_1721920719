        ...
        <div id="section-container" class="flex max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            ...
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3" :class="[transparentTextStyle, contentSubtitleStyle]">Effortlessly Monitor and Analyze Ethereum Activity</div></div>
                    <div class="flex" id="content-title-container"><h2 id="content-title" class="flex-1 h2 bg-clip-text pb-4" :class="[transparentTextStyle, contentCtaTitleStyle]"> Gain Real-Time Insights on Ethereum Transactions</h2></div>
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8" :class="[contentBodyStyle]">Our cutting-edge app harnesses the power of blockchain technology to provide you with up-to-the-minute analysis of new Ethereum transactions. Stay ahead of the curve and make informed decisions with our comprehensive analytics platform.</p></div>
